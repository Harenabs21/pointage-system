...
public class GlobalTest {
    ...
    public void testCalculateGrossSalaryWithoutOvertimeOrHolidays() {
        ...
        double expectedGrossSalary = 8 * hourlyRate + 8 * hourlyRate * 1.4; // 16 hours worked
    ...
    public void testCalculateGrossSalaryWithNightWork() {
        ...
        // Check if the calculated gross salary is as expected
        double hourlyRate = 110000.0 / 56;
        double expectedGrossSalary = (8 * hourlyRate)+ (8* hourlyRate * 1.4) + (16 * hourlyRate * 1.3); // 16 regular hours + 16 night hours at 130%
        assertEquals(expectedGrossSalary, grossSalaryRakoto);
    }
    ...
    public void testCalculateGrossSalaryWithHolidayWork() {
        ...
        // Check if the calculated gross salary is as expected
        double hourlyRate = 110000.0 / 56;
        double expectedGrossSalary = (8 * hourlyRate) + (8 * hourlyRate * 1.4)  + (8 * hourlyRate * 1.5); // 16 regular hours + 8 holiday hours at 150%
        assertEquals(expectedGrossSalary, grossSalaryRakoto);
    }
}
